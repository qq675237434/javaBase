package com.yi.design.javassist;
...
public class JavassistGenerator {
	...
	public static void main(String[] args) throws Exception{  
        ...
        CtClass cls = pool.makeClass("com.yi.design.TestClass");  
        ...
        Object o = Class.forName("com.yi.design.TestClass").newInstance();    
        ...
        o = Class.forName("com.yi.design.TestClass").getConstructor(String.class).newInstance("Liu Jian");    
